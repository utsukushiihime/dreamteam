      ...
      <div className="container text-left">
        <div className="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
          <div className="lh-100">
            <h6 className="mb-0 text-white lh-100">Resources</h6>
            <small>Only the Best</small>
          </div>
        </div>

        <div className="my-3 p-3 bg-md-dark rounded shadow-sm">
          <h6 className="border-bottom border-dark pb-2 mb-0">
            Recent updates
          </h6>
        ...
        <div className="my-3 p-3 bg-md-dark rounded shadow-sm">
          <h6 className="border-bottom border-dark pb-2 mb-0">Suggestions</h6>
          <div className="media text-muted pt-3">
            <svg
              className="bd-placeholder-img mr-2 rounded"
              width="32"
